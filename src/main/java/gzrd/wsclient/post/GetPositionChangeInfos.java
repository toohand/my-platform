...
/**
 * <p>getPositionChangeInfos complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getPositionChangeInfos">
 *   &lt;complexContent>
...
@XmlType(name = "getPositionChangeInfos", propOrder = {
    "arg0",
    "arg1"
})
public class GetPositionChangeInfos {
