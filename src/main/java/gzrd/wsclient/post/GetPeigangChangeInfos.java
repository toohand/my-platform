...
/**
 * <p>getPeigangChangeInfos complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getPeigangChangeInfos">
 *   &lt;complexContent>
...
@XmlType(name = "getPeigangChangeInfos", propOrder = {
    "arg0",
    "arg1"
})
public class GetPeigangChangeInfos {
