...
public class IDaoBuilder extends DTOCodeBuilder{
		/**
		 *  模板路径
		 */
		@Override
		public String getTemplateName() {
			return "IDaoTemplate.tld";
		}
		...
		public Map<String, Object> createMap(Class cls, Map<String, Object> map) {
			...
			if (entityClass != null) {
				...
				String classPath = (String) map.get("iDaoPath");
				String url =this.getUrl(classPath, name + "Dao.java");
				map.put("url", url);
			}
			return map;
		}
